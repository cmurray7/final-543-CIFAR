...
train_transform = transforms.Compose(
    [transforms.ToTensor(),
     ...
     transforms.RandomCrop(random_crop_param),
     transforms.RandomHorizontalFlip(p=0.3)])
#
# train_transform = transforms.Compose(
#     [transforms.ToTensor(), transforms.Normalize(torch.mean(tensor, 2), torch.std(tensor, 2))])
